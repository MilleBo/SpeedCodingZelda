...
using Zelda.Server.Infrastructure;

namespace Zelda.Server.Extensions
{
    public static class UnityContainerExtensionMethods
    {
        public static IUnityContainer RegisterMediator(this IUnityContainer container, LifetimeManager lifetimeManager)
        {
            ...
            container.RegisterMediatorValidators(Assembly.GetAssembly(typeof(LoginCommand)));
            ...
            container.RegisterMediatorHandlers(Assembly.GetAssembly(typeof(LoginCommand)));
