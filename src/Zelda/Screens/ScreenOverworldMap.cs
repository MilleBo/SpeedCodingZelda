...
{
    public class ScreenOverworldMap : Screen
    {
        private readonly OverworldMapObjects _overworldMapObjects;
        ...
        public ScreenOverworldMap(ManagerScreen managerScreen, ManagerPlayer managerPlayer, Vector2 cameraPosition)
            : base(managerScreen)
        {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(_cursorCounter > 250 ? _secondCursorTexture : _firstCursorTexture,  new Rectangle((int)(3 + (_cursorPosition.X * 8)), (int)((_cursorPosition.Y * 8) - 5), 36, 36), Color.White);
