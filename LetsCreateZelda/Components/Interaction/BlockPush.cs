...
namespace LetsCreateZelda.Components.Interaction
{
    class BlockPush : Component
    {
        ...
        {
            get { return ComponentType.BlockPush; }
        }
        ...
        public override void Update(double gameTime)
        {
            ...
            var playerAnimation = _player.GetComponent<Animation>(ComponentType.Animation);
